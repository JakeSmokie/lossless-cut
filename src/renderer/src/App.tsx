...
function App() {
  ...
  const mainActions = useMemo(() => {
    ...
    const ret: Record<MainKeyboardAction, ((a: { keyup?: boolean | undefined }) => boolean) | ((a: { keyup?: boolean | undefined }) => void)> = {
      ...
      labelCurrentSegment_set5: () => { labelSegment(currentSegIndexSafe, '5'); return false; },
      labelCurrentSegment_set6: () => { labelSegment(currentSegIndexSafe, '6'); return false; },
      labelCurrentSegment_set7: () => { labelSegment(currentSegIndexSafe, '7'); return false; },
      labelCurrentSegment_set8: () => { labelSegment(currentSegIndexSafe, '8'); return false; },
      addSegment,
